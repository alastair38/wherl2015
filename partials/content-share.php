...
<ul class="share-links columns">
	...
	<li><a href="mailto:?subject=I wanted to share this post with you from <?php bloginfo('name'); ?>&body=<?php echo str_replace($find, $replace, $string); ?>&#32;&#32;<?php echo wp_get_shortlink(); ?>" title="Email to a friend/colleague" target="_blank"><i class="fi-mail"></i></a> </li>
